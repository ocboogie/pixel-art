...
func (m *RepositoryPost) Feed(arg0 string, arg1 int, arg2 *time.Time, arg3 repositories.PostIncludes) ([]*models.Post, error) {
	m.ctrl.T.Helper()
...
func (mr *RepositoryPostMockRecorder) Feed(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Feed", reflect.TypeOf((*RepositoryPost)(nil).Feed), arg0, arg1, arg2, arg3)
}
